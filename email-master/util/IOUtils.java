...
public final class IOUtils {
	 ...
	 * @throws Exception
	 */
	public static String toStringWithLineBreak(InputStream input, String lineBreak) throws Exception {
	...
	public static void main(String[] args) {
		try {
			File doc1 = new File("E://workspace//test//doc//1272531757100_1.doc");
